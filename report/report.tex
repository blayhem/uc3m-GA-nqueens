...
% TODO: gráficos de fitness de los últimos parametros (pyplot)

\newpage
\subsection{Resultados}

A continuación podemos ver una gráfica del número de ciclos y evaluaciones requeridas para diversos valores de $N$ con las primeras versiones del algoritmo:

\begin{figure}[h]
    \center
    \begin{subfigure}{.50\textwidth}
        \includegraphics[width=\textwidth]{cycles}
    \end{subfigure}
\end{figure}
...
% TODO: gráficos de resultados de los últimos parametros (script+ods)
